...
from action_executor import preview_action, execute_action, read_action_history
...
def preview_remediation_action(request: ActionRequest):
...
def execute_remediation_action(request: ActionRequest):
...
def action_history(limit: int = 20):
    return read_action_history(limit=limit)
